...
[5 rows x 9 columns]
>>> df.groupby(['Retailer country','Year', 'Quarter']).shape
Traceback (most recent call last):
  File "<pyshell#4>", line 1, in <module>
    df.groupby(['Retailer country','Year', 'Quarter']).shape
  File "C:\Python\Python36\lib\site-packages\pandas\core\groupby\groupby.py", line 762, in __getattr__
    return self._make_wrapper(attr)
  File "C:\Python\Python36\lib\site-packages\pandas\core\groupby\groupby.py", line 799, in _make_wrapper
...
>>> df.groupby(['Retailer country','Year', 'Quarter']).set_index(['Year', 'Quarter']).head()
Traceback (most recent call last):
